...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=256, patch_size=4, in_chans=1, embed_dim=96, norm_layer=None):
        super().__init__()
        ...
        if norm_layer is not None:
            ...
            #self.norm = norm_layer(self.num_patches * embed_dim)
        else:
            self.norm = None
...
class SwinFusion(nn.Module):
    ...
    def __init__(self, img_size, patch_size=1, in_chans=1,
                 embed_dim=96, Ex_depths=[1], Fusion_depths=[1, 1], Re_depths=[1],
                 Ex_num_heads=[4], Fusion_num_heads=[8, 8], Re_num_heads=[4],
        ...
        print('SwinFusion embed_dim=',embed_dim)
        num_out_ch = in_chans
        num_feat = 64
